...
function addTask(taskText) {
    ...
    taskElement.class = 'task-text'; // Adiciona a classe de estilo ao texto da tarefa
    taskElement.textContent = taskText; // Define o texto da tarefa

    // Cria o botão da edição
    ...
    removeButton.addEventListener('click', function() {
        taskList.removeChild(listItem); // Remove o item da lista ao clica no botão de remoção
    });
    ...
    // Adiciona o novo item á lista de tarefas
